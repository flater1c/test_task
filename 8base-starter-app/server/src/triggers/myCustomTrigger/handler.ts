 ...
 *    8base invoke-local myCustomTrigger -p src/resolvers/myCustomTrigger/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local myCustomTrigger -m request
 *
 ...
 *    8base generate mock myCustomTrigger -m [MOCK_FILE_NAME]
 */
